    ...
    <div class="row">
        <div class="col">
            <div class="page-description">
                <h1>{{ config('app.name', 'Real Estate App') }} - Edit Payment</h1>
            </div>
        </div>
    </div>
    <div class="row">
                            ...
                            <form wire:submit.prevent="save">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group row mb-5">
                                        ...
                                        <div class="col-md-10">
                                            <select wire:model.lazy="property_id" wire:change="onSelectProperty($event.target.value)" class="form-control" disabled>
...
{{--                                    </div>--}}
                                    ...
                                    <div class="form-group row mb-5">
                                        ...
                                        <div class="col-md-10">
                                            <input type="date" wire:model="instalment_date" class="form-control" id="date">
