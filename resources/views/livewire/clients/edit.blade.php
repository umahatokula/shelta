            ...
            <div class="col-12">
                ...
                <div class="box">
                    <form wire:submit.prevent="save">
                        ...
                        <div class="box-body">
                            <h4 class="box-title text-info mb-0"><i class="ti-user me-15"></i> Client Details</h4>
                            <hr class="my-15">
                            ...
                            <div class="row mb-5">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select wire:model.lazy="clientProperties.{{$key}}.estate_id" wire:change="getPropertyTypes($event.target.value)"
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input wire:model.lazy="clientProperties.{{$key}}.unique_number" class="form-control"
                                            type="text" required>
